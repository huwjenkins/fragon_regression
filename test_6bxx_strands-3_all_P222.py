...
expected_result = {'darwin_ifort':0.4559, 'linux_py2_gfortran':0.52483, 'win32_gfortran':0.52404,
                   'darwin_gfortran':0.52403, 'linux_py3_gfortran':0.52403, 'minimum':0.45}
def test(tmpdir):
  os.chdir(tmpdir.strpath)
  run_test(test=tests['6bxx_strands-3_all_P222'], expected_result=expected_result, compiler=compiler, strict=strict, nproc=nproc)
